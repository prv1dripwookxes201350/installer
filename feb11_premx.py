...
def check_uptime():
    ...
    if uptime >= timedelta(minutes=3):
        ...
        while time_remaining.total_seconds() > 0:
            ...
            print("")
            print("***CHANGE LOGS (01-16-2025):")
            print(">Windows 11 24h2 is now supported but 23h2 is still recommended.")
            print(">You may change settings safely while in game by pressing home key on your keyboard.")
            print(">Fixed the issue where driver will fail to load.")
            print("")
